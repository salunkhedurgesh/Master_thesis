...
%2. At the end of execution the output will be:
 ...
 if input(prompt_para) == 0
     [Best_point_yet, ball_halfwidth] = Nelder_mead_actuator_loop(sobol_var,steps,starts,deep_file_name,points_file_name);
 else
     [Best_point_yet, ball_halfwidth] = Nelder_mead_para_weight(sobol_var,steps,starts,deep_file_name,points_file_name);
 end
