function [rho1,rho2, p_lim_uni, p_lim_sph] = configuration_space_UR(a,a_prime,h,t,ball_halfwidth,alpha,beta)
    ...
    u11_T_fixed = inv(trans_mat('x',rho1));
    u21_T_fixed = inv(trans_mat('y',rho2));
    ...
    mat_a = rot_mat2inv*trans_mat('z',-a)*rot_mat1inv*trans_mat('x',-rho1);
    mat_b = second_rot_mat2inv*trans_mat('z',-a)*second_rot_mat1inv*trans_mat('y',-rho2);
