...
function [Best_point_yet, ball_halfwidth] = Nelder_mead_actuator_loop(n, sobol_var,steps,starts,deep_file_name,points_file_name,ranges)
    ...
    for multi_start = 1:starts
        ...
        while(iteration <= steps) % stops if the solution has not changed for 10 iterations
            ...
            for i = 1:n+1
                [evaluations(i),~] = obj_func_act(S(i,1), S(i,2), S(i,3), S(i,4), S(i,5), ball_halfwidth);
            ...
            [reflect_evaluation,~] = obj_func_act(reflect_point(1), reflect_point(2), reflect_point(3), reflect_point(4), reflect_point(5), ball_halfwidth);
            ...
            elseif reflect_evaluation < min_eval
                ...
                [expand_evaluation, ~] = obj_func_act(expand_point(1), expand_point(2), expand_point(3), expand_point(4), expand_point(5),ball_halfwidth);
            ...
            elseif reflect_evaluation > second_max_eval
                ...
                if second_max_eval < reflect_evaluation && reflect_evaluation < max_eval
                    ...
                    [outside_contract_evaluation,~] = obj_func_act(outside_contract_point(1), outside_contract_point(2), outside_contract_point(3), outside_contract_point(4), outside_contract_point(5), ball_halfwidth);
                ...
                elseif reflect_evaluation > max_eval
                    ...
                    [inside_contract_evaluation,~] = obj_func_act(inside_contract_point(1), inside_contract_point(2), inside_contract_point(3), inside_contract_point(4), inside_contract_point(5), ball_halfwidth);
         ...
         [~,rho_vec]= obj_func_act(S_min(1), S_min(2), S_min(3), S_min(4), S_min(5), ball_halfwidth);
         rho1_min = rho_vec(1);
         rho1_max = rho_vec(2);
         rho2_min = rho_vec(3);
         rho2_max = rho_vec(4);
