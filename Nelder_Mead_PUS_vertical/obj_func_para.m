...
function [c_qual,rho_vec] = obj_func_para(a, a_prime, h, t, offset, ball_halfwidth)
    valid_iter = 1;
    ...
    for alpha = -1 : 0.01 :1
        for beta = -1 :0.01 :1
            ...
            [~, ~, p_lim_uni, p_lim_sph] = configuration_space_UR(a,a_prime,h,t, offset, ball_halfwidth,alpha,beta);
