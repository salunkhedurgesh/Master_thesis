function plot_limit(a, a_prime, h, t,offset,act_trigger)
    sphere_limit = 32.5;
    iter = 1;
    valid_iter = 1;
    ...
    for alpha = -1 : 0.01 :1
        for beta = -1 :0.01 :1
            [rho1, rho2, p_lim_uni, p_lim_sph] = configuration_space_UR(a,a_prime,h,t,offset,ball_halfwidth,alpha,beta);
            %Actuator lengths
            if act_trigger == 1
