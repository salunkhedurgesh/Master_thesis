...
function [type, n, ranges, starts, iterations, limits, objective_choice, sobol_var, save_files] = self_nm_input()
    ...
    %     ranges = [0.25, 1.5;  %range of x co-ordinate of universal joint of first leg
    %               0.25, 1.5;  %range of y co-ordinate of universal joint of first leg
    %               -0.1, 0.1;  %range of z co-ordinate of universal joint of first leg
    %               0.25, 2;    %range of x co-ordinate of spherical joint of first leg
    %               0.25, 2;    %range of y co-ordinate of spherical joint of first leg
    %               -0.5, 0.5;  %range of z co-ordinate of spherical joint of first leg
    %               0.25, 1.5;  %range of x co-ordinate of universal joint of second leg
    %               0.25, 1.5;  %range of y co-ordinate of universal joint of second leg
    %               -0.1, 0.1;  %range of z co-ordinate of universal joint of second leg
    %               0.25, 2;    %range of x co-ordinate of spherical joint of second leg
    %               0.25, 2;    %range of y co-ordinate of spherical joint of second leg
    %               -0.5, 0.5;  %range of z co-ordinate of spherical joint of second leg
    %                1, 4];     %range of t
    ranges = [0.25, 1.5; 0.25, 1.5; -0.1, 0.1; 0.25, 2; 0.25, 2; -0.5, 0.5; 0.25, 1.5; 0.25, 1.5; -0.1, 0.1; 0.25, 2; 0.25, 2; -0.5, 0.5; 1, 4];
    starts = 5;
    iterations = 25;
    limits = [45, 45, 1.5];
    objective_choice = "compact";
    sobol_var = 0;
    save_files = ["trial_deep_27April.txt", "trial_points_27April.txt"];
    ...
    fprintf('The mechanism is being optimised for %s\n', objective_choice);
    if sobol_var == 0
